...
weights1_gradient = np.random.uniform(-mutation_rate, mutation_rate, (211200, 48))
weights2_p1_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 4))
weights2_p2_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 109350))
weights2_p3_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 23))
weights2_p4_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 109350))
weights2_p5_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 3))
weights2_p6_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 109350))
biases3_gradient = np.random.uniform(-mutation_rate, mutation_rate, (48, 1))
biases4_p1_gradient = np.random.uniform(-mutation_rate, mutation_rate, (4, 1))
biases4_p2_gradient = np.random.uniform(-mutation_rate, mutation_rate, (109350, 1))
biases4_p3_gradient = np.random.uniform(-mutation_rate, mutation_rate, (23, 1))
biases4_p4_gradient = np.random.uniform(-mutation_rate, mutation_rate, (109350, 1))
biases4_p5_gradient = np.random.uniform(-mutation_rate, mutation_rate, (3, 1))
biases4_p6_gradient = np.random.uniform(-mutation_rate, mutation_rate, (109350, 1))
