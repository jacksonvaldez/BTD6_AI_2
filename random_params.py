...
weights3_p1 = np.random.uniform(-0.5, 0.5, (4, 109350))
weights3_p2 = np.random.uniform(-0.5, 0.5, (4, 109350))
weights3_p3 = np.random.uniform(-0.5, 0.5, (4, 109350))
weights4_p1 = np.random.uniform(-0.5, 0.5, (109350, 23))
weights4_p2 = np.random.uniform(-0.5, 0.5, (109350, 3))
